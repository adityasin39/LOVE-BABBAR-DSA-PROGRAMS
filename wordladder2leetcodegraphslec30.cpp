// the below code gives mle but is sufficient for interview
// here we apply bfs on the transformation sequence.
// if you dont understand then refer to G-30 striver notes of this lec.
// class Solution {
// public:
...
//             q.pop();
//             if(st.find(temp.back())!=st.end()) st.erase(temp.back());
//             for(int i=0;i<temp.back().size();i++)
//             {
//                 string tempword=temp.back();
//                 for(char ch='a';ch<='z';ch++)
//                 {
//                    tempword[i]=ch;
//                    if(st.find(tempword)!=st.end() && tempword!=temp.back())
//                    {
//                        vector<string> tm=temp;
//                        tm.push_back(tempword);
//                        q.push(tm);
//                        if(tempword==endWord){
//                             ans.push_back(tm);
//                             found=true;
...
// };
//
// this approach is of G-31 striver notes which gets accepted.
// if you dont understand then refer to G-31 notes.
class Solution
{
